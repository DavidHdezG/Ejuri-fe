       ...
       <div class="bg-transparent flex justify-evenly items-center h-full">
            <div class="bg-white drop-shadow-2xl rounded-full w-96">
                <div class="w-full mx-auto bg-white p-8 rounded-t-[30px]">
                    ...
                    <select v-model="category" name="category" id="category" class="w-full px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-[#A3DEE0]">
                ...
                <form action="" class="w-full mx-auto bg-white pl-8 pr-8 pb-8 rounded-b-[30px]">
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="w-full px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-[#A3DEE0]">
                    </div>
                    <div class="mb-4">
                        <label for="folio" class="block text-gray-700 text-sm font-bold mb-2">Folio</label>
                        <input type="text" name="folio" id="folio" class="w-full px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-[#A3DEE0]">
                    </div>
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 text-sm font-bold mb-2">Tipo de documento</label>
                        <select v-model="other" name="type" id="type" class="w-full px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-[#A3DEE0]">
